...
<div className="pt-4">
  <a
    href="/Lebenslauf.pdf"
    download
    className="group/btn inline-flex items-center gap-3 px-6 py-3 rounded-full
               border border-white/10 bg-white/5 hover:bg-white/10
               hover:border-white/20 hover:scale-105 transition-all
               duration-300 opacity-90 cursor-pointer w-fit"
  >
    ...
    <div className="text-left">
      ...
      <span className="block text-[10px] text-neutral-400 font-mono uppercase tracking-wider">
        lebenslauf.pdf
      </span>
    </div>
  </a>
